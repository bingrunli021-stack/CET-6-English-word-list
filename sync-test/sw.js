const CACHE='cet6-test3-shell-2';
self.addEventListener('install',e=>{e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./sync-engine.js','./supabase.min.js','./phonetics.js'])));self.skipWaiting()});
